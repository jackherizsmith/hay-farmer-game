...
export default function Home() {
  const { isPlaying, isCovering, coverProgress, startGame, resetGame } =
    useGameStore();
        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="text-center max-w-lg">
            ...
            <p className="text-xl text-amber-800 mb-8 leading-relaxed">
              ...
              destroys it. You have 2 minutes to maximise your score.
            </p>
            <div className="bg-amber-100 border-4 border-amber-800 rounded-lg p-6 mb-8 text-left">
              <h2 className="font-bold text-lg mb-3 text-amber-900">
                How to Play:
              </h2>
              <ul className="space-y-2 text-amber-900">
                ...
                <li>
                  🏚️ <strong>Cover Hay:</strong> Move field hay to barn (safe
                  forever!)
                </li>
                <li>
                  ⛔ <strong>Stop Covering:</strong> Cancel covering to make
                  more hay
                </li>
                <li>
                  ⚠️ <strong>Note:</strong> Cannot make hay whilst busy
                  covering!
                </li>
              </ul>
            </div>
